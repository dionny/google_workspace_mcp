...
class TestParagraphStyleRequestCreation:
    ...
    def test_create_request_with_negative_indent_first_line(self):
        ...
        request = create_paragraph_style_request(
            start_index=100, end_index=200, indent_start=36, indent_first_line=-36
        )
...
class TestParagraphFormattingValidation:
    ...
    def test_validate_indent_first_line_accepts_float(self):
        ...
        request = create_paragraph_style_request(
            start_index=100, end_index=200, indent_first_line=36.5
        )

        assert request is not None
        assert (
            request["updateParagraphStyle"]["paragraphStyle"]["indentFirstLine"][
                "magnitude"
            ]
            == 36.5
        )
    ...
    def test_validate_indent_start_accepts_float(self):
        ...
        request = create_paragraph_style_request(
            start_index=100, end_index=200, indent_start=72.25
        )
    ...
    def test_validate_space_above_accepts_float(self):
        ...
        request = create_paragraph_style_request(
            start_index=100, end_index=200, space_above=6.5
        )

        assert request is not None
        assert (
            request["updateParagraphStyle"]["paragraphStyle"]["spaceAbove"]["magnitude"]
            == 6.5
        )
...
class TestParagraphSpacing:
    ...
    def test_add_space_before_and_after(self):
        ...
        request = create_paragraph_style_request(
            start_index=100, end_index=200, space_above=12, space_below=6
        )
...
class TestLineSpacingNormalization:
    ...
    def test_line_spacing_decimal_multiplier_double(self):
        ...
        request = create_paragraph_style_request(
            start_index=100, end_index=200, line_spacing=200
        )
        assert request is not None
    ...
    def test_line_spacing_decimal_multiplier_one_and_half(self):
        ...
        request = create_paragraph_style_request(
            start_index=100, end_index=200, line_spacing=150
        )
        assert request is not None
    ...
    def test_line_spacing_percentage_values(self):
        ...
        for value in [50, 115, 150, 200, 500, 1000]:
            request = create_paragraph_style_request(
                start_index=100, end_index=200, line_spacing=value
            )
            assert request is not None
            assert (
                request["updateParagraphStyle"]["paragraphStyle"]["lineSpacing"]
                == value
            )
