...
async def test_delete_section_by_search(user_google_email, test_document):
    ...
    assert result_data.get('success') or result_data.get('modified'), f"Should delete section: {result}"
...
async def test_replace_with_longer_text(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should replace with longer text: {result}"
...
async def test_replace_with_shorter_text(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should replace with shorter text: {result}"
...
async def test_multiple_text_insertions(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should insert multiple texts: {result}"
...
async def test_insert_special_characters(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should handle special chars: {result}"
...
async def test_insert_unicode_characters(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should handle Unicode: {result}"
...
async def test_newline_handling(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should handle newlines: {result}"
...
async def test_insert_long_text(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should handle long text: {result}"
