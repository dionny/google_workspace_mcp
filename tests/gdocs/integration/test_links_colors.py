...
async def test_insert_hyperlink(user_google_email, test_document):
    ...
    assert result_data.get('success') or result_data.get('modified'), f"Should add hyperlink: {result}"
...
async def test_change_text_color(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should change text color: {result}"
...
async def test_change_background_color(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should change background color: {result}"
...
async def test_insert_colored_text(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should insert colored text: {result}"
...
async def test_strikethrough_formatting(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should apply strikethrough: {result}"
...
async def test_font_family_change(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should change font family: {result}"
