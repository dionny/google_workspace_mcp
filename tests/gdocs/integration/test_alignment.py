...
async def test_center_alignment(user_google_email, test_document):
    ...
    assert result_data.get('success') or result_data.get('modified'), f"Should center align: {result}"
...
async def test_right_alignment(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should right align: {result}"
...
async def test_line_spacing(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should change line spacing: {result}"
...
async def test_indent_first_line(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should indent first line: {result}"
...
async def test_paragraph_start_indent(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should indent paragraph: {result}"
...
async def test_paragraph_spacing(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should add paragraph spacing: {result}"
...
async def test_insert_with_formatting_preset(user_google_email, test_document):
    ...
    result_data = json.loads(result)
    assert result_data.get('success') or result_data.get('modified'), f"Should insert with preset formatting: {result}"
