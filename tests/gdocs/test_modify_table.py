...
class TestTableRowRequests:
    ...
    def test_insert_table_row_below(self):
        ...
        request = create_insert_table_row_request(
            table_start_index=10, row_index=2, insert_below=True, column_index=0
        )
    ...
    def test_insert_table_row_above(self):
        ...
        request = create_insert_table_row_request(
            table_start_index=10, row_index=0, insert_below=False
        )
    ...
    def test_delete_table_row_request(self):
        ...
        request = create_delete_table_row_request(
            table_start_index=15, row_index=3, column_index=0
        )
...
class TestTableColumnRequests:
    ...
    def test_insert_table_column_right(self):
        ...
        request = create_insert_table_column_request(
            table_start_index=10, row_index=0, column_index=1, insert_right=True
        )
    ...
    def test_insert_table_column_left(self):
        ...
        request = create_insert_table_column_request(
            table_start_index=10, row_index=0, column_index=2, insert_right=False
        )
    ...
    def test_delete_table_column_request(self):
        ...
        request = create_delete_table_column_request(
            table_start_index=20, row_index=0, column_index=1
        )
...
class TestRequestStructure:
    ...
    def test_insert_row_request_structure_matches_api(self):
        ...
        request = create_insert_table_row_request(
            table_start_index=5, row_index=0, insert_below=True
        )
        ...
        assert (
            "index"
            in request["insertTableRow"]["tableCellLocation"]["tableStartLocation"]
        )
    ...
    def test_delete_row_request_structure_matches_api(self):
        ...
        request = create_delete_table_row_request(table_start_index=5, row_index=1)
        ...
        assert (
            "index"
            in request["deleteTableRow"]["tableCellLocation"]["tableStartLocation"]
        )
    ...
    def test_insert_column_request_structure_matches_api(self):
        ...
        request = create_insert_table_column_request(
            table_start_index=5, row_index=0, column_index=0, insert_right=True
        )
    ...
    def test_delete_column_request_structure_matches_api(self):
        ...
        request = create_delete_table_column_request(
            table_start_index=5, row_index=0, column_index=2
        )
...
class TestDefaultValues:
    ...
    def test_insert_row_default_column_index(self):
        ...
        request = create_insert_table_row_request(
            table_start_index=10, row_index=1, insert_below=True
        )
    ...
    def test_delete_row_default_column_index(self):
        ...
        request = create_delete_table_row_request(table_start_index=10, row_index=1)
    ...
    def test_insert_row_default_insert_below(self):
        ...
        request = create_insert_table_row_request(table_start_index=10, row_index=1)
    ...
    def test_insert_column_default_insert_right(self):
        ...
        request = create_insert_table_column_request(
            table_start_index=10, row_index=0, column_index=0
        )
...
class TestDeleteRangeRequest:
    ...
    def test_delete_range_request_structure(self):
        ...
        request = create_delete_range_request(start_index=10, end_index=100)
    ...
    def test_delete_range_request_with_table_bounds(self):
        ...
        request = create_delete_range_request(start_index=50, end_index=150)
...
class TestEdgeCases:
    ...
    def test_insert_column_at_first_column(self):
        ...
        request = create_insert_table_column_request(
            table_start_index=10, row_index=0, column_index=0, insert_right=False
        )
    ...
    def test_large_table_indices(self):
        ...
        request = create_insert_table_row_request(
            table_start_index=99999, row_index=500, insert_below=True, column_index=100
        )
...
class TestMergeTableCellsRequest:
    ...
    def test_merge_cells_basic(self):
        ...
        request = create_merge_table_cells_request(
            table_start_index=10, row_index=0, column_index=0, row_span=1, column_span=2
        )
        ...
        assert (
            merge_req["tableRange"]["tableCellLocation"]["tableStartLocation"]["index"]
            == 10
        )
    ...
    def test_merge_cells_multi_row(self):
        ...
        request = create_merge_table_cells_request(
            table_start_index=15, row_index=1, column_index=2, row_span=3, column_span=1
        )
    ...
    def test_merge_cells_full_row(self):
        ...
        request = create_merge_table_cells_request(
            table_start_index=5, row_index=0, column_index=0, row_span=1, column_span=5
        )
    ...
    def test_merge_cells_request_structure_matches_api(self):
        ...
        request = create_merge_table_cells_request(
            table_start_index=10, row_index=0, column_index=0, row_span=2, column_span=2
        )
...
class TestUnmergeTableCellsRequest:
    ...
    def test_unmerge_cells_basic(self):
        ...
        assert (
            unmerge_req["tableRange"]["tableCellLocation"]["tableStartLocation"][
                "index"
            ]
            == 10
        )
    ...
    def test_unmerge_cells_multi_row(self):
        ...
        request = create_unmerge_table_cells_request(
            table_start_index=15, row_index=1, column_index=0, row_span=3, column_span=2
        )
...
class TestMergeCellsEdgeCases:
    ...
    def test_merge_single_cell(self):
        ...
        request = create_merge_table_cells_request(
            table_start_index=10, row_index=0, column_index=0, row_span=1, column_span=1
        )
...
class TestUpdateTableCellStyleRequest:
    ...
    def test_background_color_named(self):
        ...
        request = create_update_table_cell_style_request(
            table_start_index=10, row_index=0, column_index=0, background_color="yellow"
        )
    ...
    def test_default_row_column_span(self):
        ...
        request = create_update_table_cell_style_request(
            table_start_index=10, row_index=0, column_index=0, background_color="white"
        )
...
class TestUpdateTableColumnPropertiesRequest:
    ...
    def test_resize_single_column(self):
        ...
        request = create_update_table_column_properties_request(
            table_start_index=10, column_indices=[0], width=100.0
        )
    ...
    def test_resize_multiple_columns(self):
        ...
        request = create_update_table_column_properties_request(
            table_start_index=15, column_indices=[0, 2, 4], width=75.5
        )
    ...
    def test_resize_all_columns_empty_list(self):
        ...
        request = create_update_table_column_properties_request(
            table_start_index=10, column_indices=[], width=100.0
        )
    ...
    def test_request_structure_matches_api(self):
        ...
        request = create_update_table_column_properties_request(
            table_start_index=20, column_indices=[0], width=150.0
        )
    ...
    def test_minimum_width(self):
        ...
        request = create_update_table_column_properties_request(
            table_start_index=10, column_indices=[0], width=5.0
        )
    ...
    def test_large_width_value(self):
        ...
        request = create_update_table_column_properties_request(
            table_start_index=10, column_indices=[0], width=500.0
        )
