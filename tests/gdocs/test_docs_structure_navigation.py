            ...
            'tabs': [
                {
                    ...
                    'documentTab': {
                        'body': {
                            'content': [
                                {'startIndex': 0, 'endIndex': 1, 'sectionBreak': {}},
                                {'startIndex': 1, 'endIndex': 25000, 'paragraph': {'elements': []}}
                            ]
                        }
                    }
                },
                {
                    ...
                    'documentTab': {
                        'body': {
                            'content': [
                                {'startIndex': 0, 'endIndex': 1, 'sectionBreak': {}},
                                {'startIndex': 1, 'endIndex': 7000, 'paragraph': {'elements': []}}
                            ]
                        }
                    }
                }
    ...
    def test_get_body_for_tab_with_nested_child_tabs(self):
        ...
        doc_data = {
            ...
            'tabs': [{
                ...
                'documentTab': {
                    'body': {
                        'content': [{'startIndex': 0, 'endIndex': 100}]
                    }
                },
                'childTabs': [{
            ...
            'tabs': [{
                ...
                'documentTab': {
                    'body': {
                        'content': [
                            {'startIndex': 0, 'endIndex': 1, 'sectionBreak': {}},
                            {'startIndex': 1, 'endIndex': 100, 'paragraph': {'elements': [], 'paragraphStyle': {}}}
                        ]
                    }
                }
            }]
