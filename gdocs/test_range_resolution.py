...
class TestResolveRangeBySearchBounds:
    ...
    def test_resolves_simple_range(self):
        ...
        doc = create_mock_document([
            create_mock_paragraph('This is the Introduction section', 1, 'HEADING_1'),
            create_mock_paragraph('Some content in between here', 35, 'NORMAL_TEXT'),
            create_mock_paragraph('This is the Conclusion section', 65, 'HEADING_1'),
        ])
...
class TestResolveRangeBySearchWithExtension:
    ...
    def test_extends_to_paragraph(self):
        ...
        doc = create_mock_document([
            ...
            create_mock_paragraph('Second paragraph with keyword inside it', 26, 'NORMAL_TEXT'),
...
class TestResolveRangeBySearchWithOffsets:
    ...
    def test_applies_before_offset(self):
        ...
        doc = create_mock_document([
            create_mock_paragraph('This is some text with a keyword in it', 1, 'NORMAL_TEXT'),
        ])
...
class TestResolveRange:
    ...
    def test_handles_search_extend_format(self):
        ...
        doc = create_mock_document([
            ...
            create_mock_paragraph('Second paragraph with keyword', 18, 'NORMAL_TEXT'),
        ])
    ...
    def test_handles_search_offsets_format(self):
        ...
        doc = create_mock_document([
            create_mock_paragraph('Some text with a keyword in the middle', 1, 'NORMAL_TEXT'),
        ])
...
class TestFindSentenceBoundaries:
    ...
    def test_finds_sentence_containing_index(self):
        ...
        doc = create_mock_document([
            create_mock_paragraph('First sentence. Second sentence. Third sentence.', 1, 'NORMAL_TEXT'),
        ])
...
class TestSentenceBoundaryAbbreviations:
    ...
    def test_handles_common_abbreviations(self):
        ...
        doc = create_mock_document([
            create_mock_paragraph('Dr. Smith went to the store. He bought milk.', 1, 'NORMAL_TEXT'),
        ])
    ...
    def test_handles_multiple_abbreviations(self):
        ...
        doc = create_mock_document([
            create_mock_paragraph('Mr. and Mrs. Jones visited the U.S. last year. They enjoyed it.', 1, 'NORMAL_TEXT'),
        ])
    ...
    def test_exclamation_and_question_marks(self):
        ...
        doc = create_mock_document([
            create_mock_paragraph('What time is it? I think noon! That seems right.', 1, 'NORMAL_TEXT'),
        ])
